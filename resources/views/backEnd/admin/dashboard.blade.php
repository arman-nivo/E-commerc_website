...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row g-3">
            ...
            <!-- All Orders -->
            <a href="{{ route('admin.orders', ['slug' => 'all']) }}" class="col-xl-2 col-lg-4 col-md-6 mb-3">
                <div class="dashboard-card">
                    <div class="text-center mb-2">
                        <h4 class="text-dark mb-0"><span data-plugin="counterup">{{ $total_order }}</span></h4>
                    </div>
            ...
            <!-- Processing -->
            <a href="{{ route('admin.orders', ['slug' => 'processing']) }}" class="col-xl-2 col-lg-4 col-md-6 mb-3">
                <div class="dashboard-card">
                    <div class="text-center mb-2">
                        <h4 class="text-dark mb-0"><span data-plugin="counterup">{{ $total_processing }}</span></h4>
                    </div>
                    <div class="d-flex align-items-center">
            ...
            <!-- Payment Pending -->
            <a href="{{ route('admin.orders', ['slug' => 'unpaid']) }}" class="col-xl-2 col-lg-4 col-md-6 mb-3">
                <div class="dashboard-card">
                    <div class="text-center mb-2">
                        <h4 class="text-dark mb-0"><span data-plugin="counterup">{{ $total_unpaid }}</span></h4>
                    </div>
                    <div class="d-flex align-items-center">
            ...
            <!-- On Hold -->
            <a href="{{ route('admin.orders', ['slug' => 'pending']) }}" class="col-xl-2 col-lg-4 col-md-6 mb-3">
                <div class="dashboard-card">
                    <div class="text-center mb-2">
                        <h4 class="text-dark mb-0"><span data-plugin="counterup">{{ $total_pending }}</span></h4>
                    </div>
                    <div class="d-flex align-items-center">
            ...
            <!-- Canceled -->
            <a href="{{ route('admin.orders', ['slug' => 'canceled']) }}" class="col-xl-2 col-lg-4 col-md-6 mb-3">
                <div class="dashboard-card">
                    <div class="text-center mb-2">
                        <h4 class="text-dark mb-0"><span data-plugin="counterup">{{ $total_canceled }}</span></h4>
                    </div>
                    <div class="d-flex align-items-center">
            ...
            <!-- Completed -->
            <a href="{{ route('admin.orders', ['slug' => 'completed']) }}" class="col-xl-2 col-lg-4 col-md-6 mb-3">
                <div class="dashboard-card">
                    <div class="text-center mb-2">
                        <h4 class="text-dark mb-0"><span data-plugin="counterup">{{ $total_completed }}</span></h4>
                    </div>
                    <div class="d-flex align-items-center">
                        <div class="icon-circle bg-primary-soft">
        ...
        <div class="container-fluid">
            ...
            <div class="row order_page">
               ...
               {{ $value->notes->first()?->order_note ? 'bg-warning text-dark' : 'bg-primary text-white' }}"
                                                data-id="{{ $value->id }}"
                                                title="{{ $value->notes->first()?->order_note }}">
                                                {{ $value->notes->first()?->order_note ? 'Edit Note' : 'Add Note' }}
                                            </button>
