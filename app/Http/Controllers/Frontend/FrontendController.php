...
class FrontendController extends Controller
{
    public function index()
    {
        ...
        $rightBottomBanners = Banner::where([
                'status' => 1,
                'category_id' => 13
            ])
            ->select('id', 'image', 'link')
        ...
        return view('frontEnd.layouts.pages.index', compact('allProducts', 'sliders', 'frontcategory', 'hotdeal_top', 'hotdeal_bottom', 'homeproducts', 'sliderbottomads', 'footertopads', 'homepageads2', 'hitdealsbaner', 'homepageads', 'flas_sales', 'campaognads', 'reviews', 'all_products', 'brands', 'rightTopBanners', 'rightBottomBanners'));
    }
