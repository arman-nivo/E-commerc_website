...
<?php $__env->startSection('content'); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 mt-3">
                                            <div style="display: flex;gap: 12px;"
                                                class=" <?php if($details->images->count() > 4): ?> thumb_slider owl-carousel <?php endif; ?>">
                                                <?php $__currentLoopData = $details->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="my-2 indicator-item" data-id="<?php echo e($key); ?>">
                                        ...
                                        <div class="product">
                                            <div class="product-cart">
                                                ...
                                                <div class="product-code">
                                                    <p><span>Product Code : </span><?php echo e($details->product_code); ?></p>
                                                </div>
                                                ...
                                                <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="col-sm-12 col-12">
                                                        <div class="review-card">
                                                            ...
                                                            <p class="review_data">
                                                                <?php echo e($review->created_at->format('d-m-Y')); ?></p>
                                                ...
                                                <div class="modal-body">
                                                    <div class="insert-review">
                                                        <?php if(Auth::guard('customer')->user()): ?>
                                                            <form action="<?php echo e(route('customer.review')); ?>"
                                                        ...
                                                        <?php else: ?>
                                                            <a class="customer-login-redirect"
                                                                href="<?php echo e(route('customer.login')); ?>">Login
                                                                to Post
                                                                Your Review</a>
                                                        <?php endif; ?>
                                                    </div>
    ...
    function sendSuccess() {
        ...
        // Check size only if size exists
        if (form["product_size"]) {
        ...
        // Check color only if color exists
        if (form["product_color"]) {
            if (!form["product_color"].value) {
                toastr.error("Please select a color first");
                document.querySelector(".pro-color")?.scrollIntoView({ behavior: "smooth" });
                return false;
...
<?php echo $__env->make('frontEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u737498567/domains/technogeekbd.store/public_html/resources/views/frontEnd/layouts/pages/details.blade.php ENDPATH**/ ?>