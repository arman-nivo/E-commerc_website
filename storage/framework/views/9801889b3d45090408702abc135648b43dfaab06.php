    ...
    <div id="wrapper">
            ...
            <div class="container-fluid">
                <ul class="list-unstyled topnav-menu float-end mb-0">
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-lg">
                            ...
                            <div class="noti-scroll" data-simplebar>
                                <?php $__currentLoopData = $pendingorder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $porder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <!-- item-->
                                    <a href="<?php echo e(route('admin.orders', ['slug' => 'pending'])); ?>"
                                        class="dropdown-item notify-item active">
                                        <div class="notify-icon">
                                            <img src="<?php echo e(asset($porder->customer ? $porder->customer->image : '')); ?>"
                                                class="img-fluid rounded-circle" alt="" />
                                        </div>
                                        <p class="notify-details">
                                            <?php echo e($porder->customer ? $porder->customer->name : ''); ?>
                    ...
                    <li class="dropdown notification-list topbar-dropdown">
                        <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light"
                            ...
                            <span class="pro-user-name ms-1"> <?php echo e(Auth::user()->name); ?> <i
                ...
                <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                    ...
                    <li class="dropdown d-none d-xl-block">
                        <a class="nav-link " href="/" target="_blank" title="Visit Website">
        ...
        <div class="left-side-menu">
            <div class="h-100" data-simplebar>
                ...
                <div class="user-box text-center">
                    <img src="<?php echo e(asset('backEnd/assets/images/users/user-1.jpg')); ?>" alt="user-img"
                    ...
                    <ul id="side-menu">
                        ...
                        <li>
                            ...
                            <div class="collapse" id="sidebar-orders">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="<?php echo e(route('admin.orders', ['slug' => 'all'])); ?>"><i
                        ...
                        <li>
                            ...
                            <div class="collapse" id="siebar-product">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="<?php echo e(route('products.index')); ?>"><i data-feather="file-plus"></i>
                                            Product Manage</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('categories.index')); ?>"><i data-feather="file-plus"></i>
                                            Categories</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('subcategories.index')); ?>"><i data-feather="file-plus"></i>
                                            Subcategories</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('childcategories.index')); ?>"><i
                                                data-feather="file-plus"></i> Childcategories</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('brands.index')); ?>"><i data-feather="file-plus"></i>
                                            Brands</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('colors.index')); ?>"><i data-feather="file-plus"></i>
                                            Colors</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('sizes.index')); ?>"><i data-feather="file-plus"></i>
                                            Sizes</a>
                                    </li>

                                    <li>
                                        <a href="<?php echo e(route('products.price_edit')); ?>"><i data-feather="file-plus"></i>
                                            Price Edit</a>
                                    </li>
                        ...
                        <li>
                            ...
                            <div class="collapse" id="sidebar-product-review">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="<?php echo e(route('reviews.pending')); ?>"><i data-feather="file-plus"></i>
                                            Pending Reviews (<?php echo e($pending_reviews); ?>)</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('reviews.pending')); ?>"><i data-feather="file-plus"></i>
                                            Create</a>
                                    ...
                                    <li>
                                        <a href="<?php echo e(route('reviews.index')); ?>"><i data-feather="file-plus"></i> All
                                            Reviews</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li>
                            ...
                            <div class="collapse" id="sidebar-landing-page">
                                <ul class="nav-second-level">
                                    ...
                                    <li>
                                        <a href="<?php echo e(route('campaign.create')); ?>"><i data-feather="file-plus"></i>
                                            Create</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('campaign.index')); ?>"><i data-feather="file-plus"></i>
                                            Campaign</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li>
                            ...
                            <div class="collapse" id="sidebar-users">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="<?php echo e(route('users.index')); ?>"><i data-feather="file-plus"></i>
                                            User</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('roles.index')); ?>"><i data-feather="file-plus"></i>
                                            Roles</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('permissions.index')); ?>"><i data-feather="file-plus"></i>
                                            Permissions</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('customers.index')); ?>"><i data-feather="file-plus"></i>
                                            Customers</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li>
                            ...
                            <div class="collapse" id="siebar-sitesetting">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="<?php echo e(route('settings.index')); ?>"><i data-feather="file-plus"></i>
                                            General Setting</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('pixels.index')); ?>"><i data-feather="file-plus"></i> Pixels
                                            Setting</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('socialmedias.index')); ?>"><i data-feather="file-plus"></i>
                                            Social Media</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('contact.index')); ?>"><i data-feather="file-plus"></i>
                                            Contact</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('pages.index')); ?>"><i data-feather="file-plus"></i> Create
                                            Page</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('shippingcharges.index')); ?>"><i
                                                data-feather="file-plus"></i> Shipping Charge</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('orderstatus.index')); ?>"><i data-feather="file-plus"></i>
                                            Order Status</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li>
                            ...
                            <div class="collapse" id="sidebar-api-integration">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="<?php echo e(route('paymentgeteway.manage')); ?>"><i
                                                data-feather="file-plus"></i> Payment Gateway</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('smsgeteway.manage')); ?>"><i data-feather="file-plus"></i>
                                            SMS Gateway</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('courierapi.manage')); ?>"><i data-feather="file-plus"></i>
                                            Courier API</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li>
                            ...
                            <div class="collapse" id="sidebar-pixel-gtm">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="<?php echo e(route('tagmanagers.index')); ?>"><i data-feather="file-plus"></i>
                                            Tag Manager</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('pixels.index')); ?>"><i data-feather="file-plus"></i> Pixel
                                            Manage</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li>
                            ...
                            <div class="collapse" id="siebar-banner">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="<?php echo e(route('banner_category.index')); ?>"><i
                                                data-feather="file-plus"></i> Banner Category</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('banners.index')); ?>"><i data-feather="file-plus"></i>
                                            Banner & Ads</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li>
                            ...
                            <div class="collapse" id="sitebar-report">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="<?php echo e(route('admin.stock_report')); ?>"><i data-feather="file-plus"></i>
                                            Stock Report</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('customers.ip_block')); ?>"><i data-feather="file-plus"></i>
                                            IP Block</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('admin.order_report')); ?>"><i data-feather="file-plus"></i>
                                            Order Reports</a>
                                    </li>
                                </ul>
                            </div>
        ...
        <div class="content-page">
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12 text-end"><a href="https://neonexor.com"
                                target="_blank">Website Designed by: neoNexor</a>
                            </div>
                    </div>
                </div>
            </footer>
...
<?php /**PATH /home/u737498567/domains/technogeekbd.store/public_html/resources/views/backEnd/layouts/master.blade.php ENDPATH**/ ?>