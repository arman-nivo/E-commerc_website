    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form action="<?php echo e(route('admin.order.update')); ?>" method="POST" class="row pos_form"
                                        ...
                                        <?php $__currentLoopData = $cartinfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                    ...
                                                    <?php if($product && ($product->sizes->isNotEmpty() || $product->colors->isNotEmpty())): ?>
                                                        <div class="row g-1">
                                                            ...
                                                            <?php if($product->sizes->isNotEmpty()): ?>
                                                                <div class="col-md-6">
                                                                    <select id="size-selector-<?php echo e($value->rowId); ?>"
                                                                        class="form-select form-select-sm cart-size-selector"
                                                                        ...
                                                                        <?php $__currentLoopData = $product->sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <option value="<?php echo e($size->sizeName); ?>"
                                                                                <?php echo e($size->sizeName == $value->options->product_size ? 'selected' : ''); ?>>
                                                                                <?php echo e($size->sizeName); ?>

                                                                            </option>
                                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                    </select>
                                                                    <label for="size-selector-<?php echo e($value->rowId); ?>"
                                                            ...
                                                            <?php if($product->colors->isNotEmpty()): ?>
                                                                <div class="col-md-6">
                                                                    <select id="color-selector-<?php echo e($value->rowId); ?>"
                                                                        ...
                                                                        <?php $__currentLoopData = $product->colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <option value="<?php echo e($color->colorName); ?>"
                                                                                <?php echo e($color->colorName == $value->options->product_color ? 'selected' : ''); ?>>
                                                                                <?php echo e($color->colorName); ?>

                                                                            </option>
                                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                    </select>
                                                                    <label for="color-selector-<?php echo e($value->rowId); ?>"
                                                                        class="form-label text-muted text-start"
                                                ...
                                                <td>
                                                    <div class="qty-cart vcart-qty">
                                                        <div class="quantity">
                                                            ...
                                                            <button class="plus cart_increment" value="<?php echo e($value->qty); ?>"
                                                                data-id="<?php echo e($value->rowId); ?>">+</button>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="discount"><input type="number" class="product_discount"
                                                        value="<?php echo e($value->options->product_discount); ?>" placeholder="0.00"
                                                        data-id="<?php echo e($value->rowId); ?>">
                                                </td>
                                                <td><?php echo e(($value->price - $value->options->product_discount) * $value->qty); ?>

                                                </td>
                                                <td><button type="button" class="btn btn-danger btn-xs cart_remove"
                                                        data-id="<?php echo e($value->rowId); ?>"><i class="fa fa-times"></i></button>
                                                </td>
                                            </tr>
                                            <?php
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                value="<?php echo e($shippinginfo->name); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                value="<?php echo e($shippinginfo->phone); ?>" required>
...
unset($__errorArgs, $__bag); ?>" name="address"
                                                value="<?php echo e($shippinginfo->address); ?>" required>
...
unset($__errorArgs, $__bag); ?>" name="area"
                                                ...
                                                <?php $__currentLoopData = $shippingcharge; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($value->id); ?>"
                                                        <?php if($shippinginfo->area == $value->name): ?> selected <?php endif; ?>>
...
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u737498567/domains/technogeekbd.store/public_html/resources/views/backEnd/order/edit.blade.php ENDPATH**/ ?>