...
<!-- Sidebar -->
            ...
            <div>
                ...
                <li class="menu-links d-flex align-items-center gap-3 flex-wrap manulink">
                    ...
                    <a href="<?php echo e(route('brands')); ?>" style="<?php echo e(request()->routeIs('brands') ? 'color:#40b9eb;' : ''); ?>" class="<?php echo e(request()->routeIs('brands') ? 'fw-bold ' : ''); ?>">All Brands</a>
            ...
            <div  style="display: flex;flex-direction: row;gap: 29px; align-items: center;">
                ...
                <a href="<?php echo e(route('customer.checkout')); ?>">
                    <p class="margin-shopping">
                        <i class="fa-solid fa-cart-shopping fs-5 fw-semibold text-white"></i>
                        <span class=""><?php echo e(Cart::instance('shopping')->count()); ?></span>
                    </p>
                </a>
                <div class="cshort-summary">
                    <ul>
                        ...
                        <li style="color:black">Qty: <?php echo e($value->qty); ?></li>
                        <li >
...
<?php /**PATH D:\Laravel\New_website\resources\views/frontEnd/layouts/master.blade.php ENDPATH**/ ?>