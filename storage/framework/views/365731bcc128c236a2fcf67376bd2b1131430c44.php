            ...
            <div class="col-sm-12">
             ...
             <div class="col-sm-10">
                <div class="contact-form">
                    ...
                    <form action="<?php echo e(route('contact.submit')); ?>" method="POST" class="row">
                        <?php echo csrf_field(); ?>
                        <div class="col-sm-6">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u737498567/domains/technogeekbd.store/public_html/resources/views/frontEnd/layouts/pages/contact.blade.php ENDPATH**/ ?>