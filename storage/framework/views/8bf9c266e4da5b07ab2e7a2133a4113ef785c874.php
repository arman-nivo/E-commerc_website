...
<!-- Sidebar -->
            ...
            <div>
                ...
                <li class="menu-links d-flex align-items-center gap-3 flex-wrap manulink">
                    <a href="<?php echo e(route('home')); ?>" style="<?php echo e(request()->routeIs('home') ? 'color:#40b9eb;' : ''); ?>" class="<?php echo e(request()->routeIs('home') ? 'fw-bold' : ''); ?>">Home</a>   
                    <a href="<?php echo e(route('shop')); ?>" style="<?php echo e(request()->routeIs('shop') ? 'color:#40b9eb;' : ''); ?>" class="<?php echo e(request()->routeIs('shop') ? 'fw-bold' : ''); ?>">All Products</a>

                    

                    <a href="<?php echo e(route('hotdeals')); ?>" style="<?php echo e(request()->routeIs('hotdeals') ? 'color:#40b9eb;' : ''); ?>" class="<?php echo e(request()->routeIs('hotdeals') ? 'fw-bold ' : ''); ?>">Hot Deals</a>

                    <a href="<?php echo e(route('flashsales')); ?>" style="<?php echo e(request()->routeIs('flashsales') ? 'color:#40b9eb;' : ''); ?>" class="<?php echo e(request()->routeIs('flashsales') ? 'fw-bold ' : ''); ?>">Flash Sales</a>

                    <a href="<?php echo e(route('contact')); ?>" style="<?php echo e(request()->routeIs('contact') ? 'color:#40b9eb;' : ''); ?>" class="<?php echo e(request()->routeIs('contact') ? 'fw-bold ' : ''); ?>">Contact</a>
            ...
            <div class="main-search flex-grow-1 mx-4" style="max-width: 350px;">
                <form action="<?php echo e(route('search')); ?>" class="d-flex">
                    <input type="text" 
            ...
            <div  style="display: flex;flex-direction: row;gap: 29px; align-items: center;">
                <a title="Track Order" href="<?php echo e(route('customer.order_track')); ?>" class="d-flex align-items-center text-white">
...
<div class="cart-sidebar" id="cart-sidebar">
    ...
    <div class="cart-sidebar-content"  style="display: flex;  flex-direction: column;gap: 10px;">
        <ul>
            ...
            <li class="cart-item">
                <a href="#"><img src="<?php echo e(asset($item->options->image)); ?>" alt="" /></a>
                <div class="cart-item-details">
                    ...
                    <button class="remove-cart cart_remove" data-id="<?php echo e($item->rowId); ?>">
                        <i data-feather="x"></i>
                    </button>
                </div>
            </li>
        ...
        <p><strong>Total : ৳<?php echo e(Cart::instance('shopping')->subtotal()); ?></strong></p>
                 ...
                 <!-- Account / Login -->
                        <div>
                            <?php if(Auth::guard('customer')->check()): ?>
                                <a href="<?php echo e(route('customer.account')); ?>" class="d-flex align-items-center text-white">
                                    <i class="fa-regular fa-user me-1"></i>
                                    <?php echo e(Str::limit(Auth::guard('customer')->user()->name, 14)); ?>

                                </a>
                            <?php else: ?>
                                <a href="<?php echo e(route('customer.login')); ?>" class="d-flex fs-6 fw-semibold align-items-center text-white">
                                    <i class="fa-regular fa-user me-1"></i>
                                    Login / Sign Up
                                </a>
                            <?php endif; ?>
...
">
                            <div class="copyright">
								<a href="">
                                        <img src="<?php echo e(asset('frontEnd/images/sslcom.png')); ?>" alt="" />
                                    </a>
                            </div>
                        </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="copyright">
								...
								<p><span style="color: white;">Copyright © <?php echo e(date('Y')); ?> <?php echo e($generalsetting->name); ?>. All rights reserved </span> | <span style="color: white;">Website Designed by: <a target="_blank" href="https://neonexor.com"><span style="color: #71a3c1;font-weight: bold;">neoNexor</span></a></span></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <a href="<?php echo e(route('customer.checkout')); ?>">
                        <span>
                            <i class="fa-solid fa-cart-shopping"></i>
                             (<b class="mobilecart-qty"><?php echo e(Cart::instance('shopping')->count()); ?></b>)
                        </span>
...
<?php /**PATH /home/u737498567/domains/technogeekbd.store/public_html/resources/views/frontEnd/layouts/master.blade.php ENDPATH**/ ?>